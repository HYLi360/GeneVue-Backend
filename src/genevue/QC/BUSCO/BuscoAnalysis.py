...
from genevue.QC.BUSCO.BuscoConfig import BaseConfig, BuscoConfigAuto
...
from genevue.QC.BUSCO.hmmer import HMMERRunner
...
class BuscoAnalysis(metaclass=ABCMeta):
    ...
    def cleanup(self):
        ...
        try:
            shutil.rmtree(os.path.join(self.main_out, "tmp_dir"))
        except OSError:
            pass
