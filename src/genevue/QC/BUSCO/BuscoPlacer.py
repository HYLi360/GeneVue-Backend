...
from genevue.QC.BUSCO.sepp import SEPPRunner
...
class BuscoPlacer:
    ...
    def _run_sepp(self):
        ...
        while (
            ...
            and self.sepp_runner.run_number < 3
        ):
        ...
        if not os.path.exists(
            ...
            raise BuscoError(
                "SEPP run failed. Try to rerun increasing the memory or select a lineage manually."
            )
